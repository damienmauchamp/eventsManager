 ...
 */
class Version20180312150527 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE event ADD id_event INT AUTO_INCREMENT NOT NULL, DROP id, ADD PRIMARY KEY (id_event)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE event ADD id INT NOT NULL, DROP id_event');
